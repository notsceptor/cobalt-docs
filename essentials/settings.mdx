...
<ResponseField name="navigation" type="Navigation[]" required>
  ...
  <Expandable title="Navigation">
    ...
    Example: `["introduction", "installation"]` 
...
<ResponseField name="logo" type="string or object">
  ...
  <Expandable title="Logo">
    <ResponseField name="light" type="string">
      Path to the logo in light mode (e.g., `/images/logo-light.svg`)
    </ResponseField>
    <ResponseField name="dark" type="string">
      Path to the logo in dark mode (e.g., `/images/logo-dark.svg`)
    </ResponseField>
    <ResponseField name="href" type="string" default="/">
      Where clicking on the logo links you to (e.g., your bot's website)
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="colors" type="Colors">
  ...
  <Expandable title="Colors">
    <ResponseField name="primary" type="string" required>
      ...
      **Recommendation:** `#FFFFFF` (white) or a light gray like `#F5F5F5`

    </ResponseField>
    <ResponseField name="light" type="string">
      The primary color for dark mode. Used most often for highlighted content, section headers, accents.

      **Recommendation:** A darker gray like `#555555` or `#333333`
    </ResponseField>
    <ResponseField name="dark" type="string">
      The primary color for important buttons. 

      **Recommendation:** A medium gray like `#888888` or your primary color with reduced opacity.
    </ResponseField>
      ...
      <Expandable title="Object">
        <ResponseField name="light" type="string" required>
          The hex color code of the background in light mode
            ...
            **Recommendation:**  `#FFFFFF` (white) or an off-white like `#FAFAFA`
        </ResponseField>
        <ResponseField name="dark" type="string" required>
          The hex color code of the background in dark mode

            **Recommendation:** `#121212` or a very dark gray
        </ResponseField>
      </Expandable>
    </ResponseField>
  </Expandable>
